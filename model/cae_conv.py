...
class ConvCAE(ModelBase):

    def __init__(self, model_metadata, *args, **kwargs):  # 117
        super(ConvCAE, self).__init__(model_metadata=model_metadata, *args, **kwargs)
    ...
    def training_step(self, batch, batch_idx):
        ...
        Optimize model
        """
        loss = self.model_loss_function(x=x_id_batch, x_hat=x_id_hat_batch, target=y_id_batch, z_in=z_in, z_out=z_out)
