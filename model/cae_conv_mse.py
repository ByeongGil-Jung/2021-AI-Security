...
class ConvCAEMse(ModelBase):

    def __init__(self, model_metadata, *args, **kwargs):  # 117
        super(ConvCAEMse, self).__init__(model_metadata=model_metadata, *args, **kwargs)
        ...
        # Config
        self.model_loss_function = Criterion.mse_loss
    ...
    def training_step(self, batch, batch_idx):
        ...
        Optimize model
        """
        loss = self.model_loss_function(x=x_id_batch, x_hat=x_id_hat_batch)
    ...
    def test_step(self, batch, batch_idx):
        ...
        loss = self.model_loss_function(x=x_batch, x_hat=x_hat_batch)
